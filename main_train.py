...
if __name__ == '__main__':
    ...
    args.abits = 4
    args.headwise = True
    args.input_noise_std = 0.3  # 0.3
    args.input_noise_std_w = 0.3  # 0.3
    args.output_noise_std = 0.01  # 0.01
    args.phase_noise_std = 0  # 0
    args.num_wavelength = 1
    args.channel_spacing = 0.4
    args.seed = 0
    args.enable_wdm_noise = False  # False
    args.enable_linear_noise = True  # True
